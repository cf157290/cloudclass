...
public class ExcelUtils {
     ...
     */
    public static void export(HttpServletResponse response, List<?> importlist, String[] attributeNames) throws UnsupportedEncodingException {
        //获取数据集
        ...
        String fileName=new String(("学生平时成绩" + sdf.format(new Date()) + ".xls").getBytes("UTF-8"), "ISO8859-1");
        //默认Excel名称
